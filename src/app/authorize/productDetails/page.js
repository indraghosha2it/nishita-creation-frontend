...
//     'Trending': 'bg-gradient-to-r from-[#72846A] to-pink-800 text-white shadow-lg shadow-[#72846A]/30',
//     'New Release': 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/30',
//     'Limited Offer': 'bg-gradient-to-r from-purple-500 to-[#72846A] text-white shadow-lg shadow-purple-500/30',
...
//   };
//   return styles[tagName] || 'bg-gradient-to-r from-[#72846A] to-black text-white shadow-lg shadow-[#72846A]/30';
// };
...
//   className="p-2 bg-white rounded-xl border border-gray-200 hover:border-[#72846A] transition-all shadow-sm hover:shadow-md"
// >
//   <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 hover:text-[#72846A]" />
// </button>
//             <div>
...
//             <button
//               onClick={handleEdit}
//               className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-[#72846A] text-white font-semibold rounded-lg hover:bg-[#56694d] transition-all text-xs sm:text-sm shadow-md hover:shadow-lg"
//             >
...
//           <Link href="/authorize/dashboard" className="text-gray-500 hover:text-[#72846A] transition whitespace-nowrap">Dashboard</Link>
//           <span className="text-gray-300">/</span>
//           <Link href="/authorize/all-products" className="text-gray-500 hover:text-[#72846A] transition whitespace-nowrap">Products</Link>
//           <span className="text-gray-300">/</span>
...
//                         <ZoomIn className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-[#72846A]" />
...
//                       >
//                         <Maximize2 className="w-3 h-3 sm:w-4 sm:h-4 text-[#72846A]" />
//                       </button>
//                     )}
//                   </div>
...
//                 {discountPercent > 0 && (
//                   <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-[#72846A] text-white text-[8px] sm:text-[10px] md:text-sm font-bold px-1.5 py-0.5 sm:px-2.5 sm:py-1.5 rounded-full shadow-lg flex items-center gap-0.5 sm:gap-1">
...
//                       activeImageIndex === idx ? 'border-[#72846A] shadow-[0_0_0_3px_rgba(59,130,246,0.2)]' : 'border-gray-200 hover:border-pink-400'
//                     }`}
//                   >
...
//                       activeImageIndex === productImages.length ? 'border-[#72846A] shadow-[0_0_0_3px_rgba(59,130,246,0.2)]' : 'border-gray-200 hover:border-pink-400'
//                     }`}
//                   >
...
//                       {generatingThumbnail ? (
//                         <>
//                           <Loader2 className="w-3 h-3 sm:w-4 sm:h-4 text-[#72846A] animate-spin" />
//                           <span className="text-[5px] sm:text-[6px] md:text-[8px] text-[#72846A] mt-0.5">Loading</span>
//                         </>
//                       ) : (
//                         <>
//                           <Play className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#72846A]" />
//                           <span className="text-[5px] sm:text-[6px] md:text-[8px] text-[#72846A] mt-0.5">Video</span>
//                         </>
//                       )}
//                     </div>
...
//                 <span 
//                   key={idx} 
//                   className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full [#c4d1be] text-[#56694d] border border-[#a6ba9c]"
//                 >
...
//               {product.brand && (
//                 <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full [#c4d1be] text-[#56694d] border border-[#a6ba9c]">
...
//             <div className="mb-4 sm:mb-5 p-3 sm:p-4 bg-gradient-to-r from-pink-50 to-gray-50 rounded-xl border border-[#a6ba9c]">
//               <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
//                 <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#72846A]">
//                   ৳{formatPrice(currentPrice)}
//                 </span>
//                 {discountPercent > 0 && (
//                   <>
//                     <span className="text-sm sm:text-base text-gray-400 line-through">৳{formatPrice(product.regularPrice)}</span>
//                     <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-semibold text-white bg-[#72846A] px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full">
...
//                   <AlertCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#72846A]" />
...
//                     <Box className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#72846A]" />
//                     Packaging Cost
//                   </p>
...
//                 <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
//                   <p className="text-[8px] sm:text-[10px] text-gray-500 flex items-center gap-1">
//                     <Truck className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#72846A]" />
//                     Delivery Cost
//                   </p>
//                   <p className="text-sm sm:text-base font-bold text-gray-900">
...
//                 <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
//                   <p className="text-[8px] sm:text-[10px] text-gray-500 flex items-center gap-1">
//                     <DollarSign className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#72846A]" />
//                     Cost Per Item
//                   </p>
//                   <p className="text-sm sm:text-base font-bold text-gray-900">
...
//               <div className="bg-gradient-to-r from-pink-50 to-gray-50 rounded-xl p-3 sm:p-4 border border-[#a6ba9c] mb-4">
//                 <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
//                   <Truck className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-[#72846A]" />
...
//                 />
//                 <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-[#a6ba9c]/50">
...
//                   <ClockIcon className="w-3.5 h-3.5 text-[#72846A]" />
...
//                     activeTab === tab 
//                       ? 'bg-white text-[#72846A] border-t-2 border-l-2 border-r-2 border-[#a6ba9c] border-b-white shadow-sm' 
...
//                     <span className="bg-pink-100 text-[#72846A] text-[10px] px-1.5 py-0.5 rounded-full ml-1">
//                       {product.faqs.length}
//                     </span>
//                   )}
//                 </button>
...
//                       <item.icon className={`w-3 h-3 sm:w-4 sm:h-4 ${item.isAdminOnly ? 'text-amber-600' : 'text-[#72846A]'}`} />
//                     </div>
//                     <div>
...
//                           <Info className="w-3 h-3 sm:w-4 sm:h-4 text-[#72846A]" />
//                         </div>
//                         <div>
...
//                         <div className="p-2 bg-[#72846A] rounded-xl shadow-lg shadow-[#a6ba9c]">
...
//                         <FileText className="w-4 h-4 text-[#72846A]" />
...
//                                 : 'border-gray-200 hover:border-[#a6ba9c] bg-white'
//                             }`}
//                           >
...
//                             >
//                               {/* Number */}
//                               <span className="flex-shrink-0 w-7 h-7 rounded-full bg-pink-100 text-[#72846A] flex items-center justify-center text-sm font-bold">
//                                 {index + 1}
//                               </span>
...
//                                 <ChevronDown className="w-5 h-5 text-[#72846A]" />
//                               </div>
//                             </button>
...
//                 <Tag className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#72846A]" />
//                 Product Tags
//               </h3>
...
//             <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 p-3 sm:p-4 shadow-sm">
//               <h3 className="font-semibold text-gray-900 mb-2 sm:mb-3 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base">
//                 <Palette className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#72846A]" />
//                 Available Colors
//               </h3>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6 lg:py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-4 md:gap-6 lg:gap-8">
                ...
                {productImages.map((img, idx) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-lg overflow-hidden border-2 transition-all duration-200 ${
                      activeImageIndex === idx ? 'border-[#72846A] shadow-[0_0_0_3px_rgba(236,72,153,0.2)]' : 'border-gray-200 hover:border-pink-400'
                    }`}
                  >
                    <img src={img.url} alt={`Thumb ${idx + 1}`} className="w-full h-full object-cover" />
                  </button>
                ...
                {hasVideo && (
                  <button
                    ...
                    className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-lg overflow-hidden border-2 transition-all duration-200 relative ${
                      activeImageIndex === productImages.length ? 'border-[#72846A] shadow-[0_0_0_3px_rgba(236,72,153,0.2)]' : 'border-gray-200 hover:border-pink-400'
                    }`}
                  >
                    {product.videoType === 'youtube' && getYouTubeThumbnail(product.videoUrl) ? (
                ...
                <div id="variant-table-area" className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50/60">
                    <div className="flex items-center gap-2">
                      <Layers className="w-4 h-4 text-[#72846A]" />
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-center gap-1.5">
                                        ...
                                        {hasSubs && (
                                          <span className="text-[9px] font-semibold text-[#56694d] [#c4d1be] border border-[#a6ba9c] px-1.5 rounded-full flex items-center gap-0.5">
                                      ...
                                      <div className="flex items-center gap-2 mt-0.5 text-[10px]">
                                        {vHasDiscount ? (
                                          <>
                                            <span className="text-[#72846A] font-bold">৳{formatPrice(vDiscount)}</span>
                                          ...
                                          >
                                            ...
                                            <div className="flex-1 min-w-0">
                                              ...
                                              <div className="flex items-center gap-1.5 text-[10px]">
                                                {sHasDiscount ? (
                                                  <>
                                                    <span className="text-[#72846A] font-bold">৳{formatPrice(sDiscount)}</span>
          ...
          <div className="lg:col-span-4 bg-white p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 mb-3 sm:mb-4">
              {categoryHierarchy.map((cat, idx) => (
                <span key={idx} className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full [#c4d1be] text-[#56694d] border border-[#a6ba9c]">
                  <FolderTree className="w-2 h-2 sm:w-2.5 sm:h-2.5" />
                  {cat}
                </span>
              ))}
        ...
        {hasAddOns && (
          <div className="mt-6 sm:mt-10">
            <div className="flex items-center gap-2 mb-4">
              <div className="p-2 bg-[#72846A] rounded-xl">
                    ...
                    <div key={id || idx} className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:border-pink-300 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                          {hasDiscount ? (
                            <>
                              <span className="text-sm font-bold text-[#72846A]">৳{formatPrice(discount)}</span>
                              <span className="text-xs text-gray-400 line-through">৳{formatPrice(regular)}</span>
                              <span className="text-[9px] font-semibold text-white bg-[#72846A] px-1.5 py-0.5 rounded">
                      ...
                      {product.faqs.map((faq, index) => {
                        ...
                        return (
                          <div key={index} className={`border rounded-xl transition-all duration-300 overflow-hidden ${
                            isOpen ? 'border-[#a2b897] shadow-md shadow-[#cee0c5] bg-white' : 'border-gray-200 hover:border-[#a6ba9c] bg-white'
                          }`}>
                            <button
                              onClick={() => toggleFaq(index)}
                              className="w-full flex items-center gap-4 px-5 py-4 text-left hover:bg-gray-50 transition-colors"
                            >
                              <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#cee0c5] text-[#72846A] flex items-center justify-center text-sm font-bold">
                                {index + 1}
                              </span>
                              <span className="flex-1 font-semibold text-gray-900 text-base sm:text-lg">
                                {faq.question}
