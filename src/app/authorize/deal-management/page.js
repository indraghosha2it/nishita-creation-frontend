...
//           <div
//             className={`rounded-lg overflow-hidden border-2 border-pink-500/30 bg-gray-100`}
...
//             Size:1697x927px, JPG, PNG, WebP (max 5MB)
//           </span>
//         </div>
//       )}
...
//       const data = await response.json();
//       if (data.success) {
//         // sort by displayOrder client-side too, in case
...
//         image: deal.image || '',
//         buttonText: deal.buttonText || '', // ← preserve empty
...
//       // Preserve empty buttonText explicitly
//       const submitData = {
//         ...formData,
...
//         closeModal();
//         toast.success(
//           editingDeal ? 'Deal updated successfully!' : 'Deal created successfully!'
//         );
//       }
//     } catch (error) {
...
//       const data = await response.json();
//       if (data.success) {
//         // Use canonical data from server
//         const sorted = [...data.data].sort(
//           (a, b) => (a.displayOrder || 0) - (b.displayOrder || 0)
//         );
//         setDeals(sorted);
//         toast.success('Deals reordered');
//       }
//     } catch (error) {
//       console.error('Reorder error:', error);
//       toast.error(error.message || 'Failed to reorder deals');
...
//               Manage &quot;Deals You Can&apos;t Miss&quot; section — drag cards to
//               reorder
//             </p>
//           </div>
//           <button
...
//             <h3 className="text-lg font-medium text-[#2D1B2E]">
//               No deals yet
//             </h3>
//             <p className="text-gray-500 text-sm mt-1">
...
//                   } ${
//                     isDragOver
//                       ? 'border-[#72846A] ring-2 ring-[#72846A]/30 shadow-lg'
//                       : 'border-pink-200/30 hover:shadow-lg'
...
//                           {deal.buttonText} → {deal.buttonLink}
//                         </span>
//                       </div>
//                     ) : (
//                       <div className="flex items-center gap-2 mt-2 text-xs text-gray-300 italic">
//                         <Link className="w-3 h-3" />
//                         <span>No button</span>
//                       </div>
//                     )}
...
//                       Button Text{' '}
//                       <span className="text-gray-400 text-xs font-normal">
//                         (Optional — leave empty to hide button)
//                       </span>
//                     </label>
//                     <input
//                       type="text"
    ...
    <div className={`space-y-2 ${className}`}>
      ...
      {preview ? (
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-xs text-gray-400">
            Size:1851x462px, JPG, PNG, WebP (max 5MB)
          </span>
        </div>
      )}
      {error && <p className="text-xs text-red-500">{error}</p>}
