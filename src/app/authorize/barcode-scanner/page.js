...
//               <Scan className="w-6 h-6" style={{ color: '#CA1C33' }} />
...
//                       className="px-3 py-1.5 bg-[#CA1C33] text-white rounded-lg text-sm hover:bg-[#A6242E] flex items-center gap-1"
//                     >
...
//                   className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CA1C33] focus:border-transparent outline-none"
//                   autoFocus
//                 />
//                 <button
//                   type="submit"
//                   className="px-4 py-2 bg-[#CA1C33] text-white rounded-lg hover:bg-[#A6242E] flex items-center gap-2"
//                 >
...
//               <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#CA1C33' }} />
...
//               {/* Product Header */}
//               <div className="relative h-36 bg-gradient-to-r from-[#CA1C33] to-[#6BA3A8] p-6 text-white">
...
//                                 ? 'border-[#CA1C33] shadow-md ring-2 ring-[#CA1C33]/20' 
...
//                           <span key={idx} className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-[#CA1C33]/10 text-[#CA1C33] border border-[#CA1C33]/20">
...
//                         </>
//                       ) : (
//                         <span className="text-3xl font-bold text-[#CA1C33]">
//                           ৳{formatPrice(product.regularPrice)}
//                         </span>
//                       )}
//                     </div>
...
//                           <span key={idx} className="px-2 py-1 bg-[#D4EDEE] text-[#CA1C33] rounded-full text-xs font-medium">
//                             {tag}
//                           </span>
//                         ))}
//                       </div>
...
//                       <button
//                         onClick={goToProductPage}
//                         className="flex-1 py-2 bg-gradient-to-r from-[#CA1C33] to-[#A6242E] text-white font-semibold rounded-lg hover:from-[#A6242E] hover:to-[#5B9399] transition flex items-center justify-center gap-2"
//                       >
//                         <Eye className="w-4 h-4" />
...
//                           activeTab === tab 
//                             ? 'bg-white text-[#CA1C33] border-t-2 border-l-2 border-r-2 border-[#FFE0E6] border-b-white' 
//                             : 'text-gray-500 hover:text-[#CA1C33]'
//                         }`}
//                       >
...
//                             <item.icon className="w-5 h-5 text-[#CA1C33]" />
//                             <div>
...
//                             <Truck className="w-5 h-5 text-[#CA1C33]" />
...
//                 <ClipboardList className="w-4 h-4 text-[#CA1C33]" />
//                 Recent Scans
//               </h3>
...
export default function BarcodeScannerPage() {
  ...
  // ✅ NEW: Helper to safely get tag display name
  const getTagDisplay = (tag) => {
    if (!tag) return { name: '', image: null, key: '' };
    if (typeof tag === 'string') {
      return { name: tag, image: null, key: tag };
    }
    return {
      name: tag.name || '',
    ...
    <>
      ...
      <div className="min-h-screen p-6" style={{ backgroundColor: '#FFF9F0' }}>
        <div className="max-w-6xl mx-auto">
          ...
          {product && !loading && (
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              ...
              {/* Product Header */}
              <div className="relative h-36 bg-white border border-gray-200 p-6 text-[#CA1C33]">
                <h2 className="text-2xl font-bold mb-2">{product.productName}</h2>
                <p className="opacity-90">{product.brand}</p>
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  {product.ageGroup && (
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* ✅ FIXED: Tags — handle objects safely */}
                    {product.tags && product.tags.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {product.tags.slice(0, 5).map((tag, idx) => {
                          const { name, image, key } = getTagDisplay(tag);
                          if (!name) return null;
                          return (
                            <span 
                              key={key || idx} 
                              className="inline-flex items-center gap-1 px-2 py-1 bg-[#D4EDEE] text-[#CA1C33] rounded-full text-xs font-medium"
                            >
                              {image && (
                                <img 
                                  src={image} 
        ...
        <style jsx global>{`
          ...
          .prose h1 { font-size: 1.5em; font-weight: 600; margin: 0.75em 0 0.5em; color: #2D3A5C; }
          .prose h2 { font-size: 1.3em; font-weight: 600; margin: 0.7em 0 0.4em; color: #2D3A5C; }
          .prose h3 { font-size: 1.1em; font-weight: 600; margin: 0.6em 0 0.3em; color: #2D3A5C; }
          ...
          .prose a { color: #CA1C33; text-decoration: underline; }
          .prose strong { font-weight: 600; color: #2D3A5C; }
