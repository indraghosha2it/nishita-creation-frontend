    ...
    return (
      <div className="min-h-screen bg-[#f8f7f2] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#53645a] font-medium">Loading your profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-3xl font-light text-[#263b32]">Agent Profile</h1>
            <Sparkles className="w-5 h-5 text-[#8B9D83] ml-1" />
          </div>
          <p className="text-[#53645a] text-sm ml-14">Manage your call center agent account information</p>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#c5d5be]/40">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1">
                        <span className="px-3 py-1 bg-[#f0f5ed] text-[#8B9D83] rounded-full text-xs font-medium border border-[#8B9D83]/30">
                          Call Center Agent
                        </span>
                        <Headphones className="w-4 h-4 text-[#8B9D83]" />
                        {userData.companyName && (
                          <span className="px-3 py-1 bg-[#c5d5be]/20 text-[#263b32] rounded-full text-xs font-medium border border-[#263b32]/20">
                            <Building2 className="w-3 h-3 inline mr-1" />
                            {userData.companyName}
                          </span>
                        )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        {userData.companyName && (
                          <div className="flex items-start gap-3 p-3 bg-[#f0f5ed] rounded-lg border border-[#c5d5be]/40">
                            ...
                            <div>
                              <p className="text-xs text-[#53645a]">Company</p>
                              <p className="text-sm font-medium text-[#263b32]">{userData.companyName}</p>
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 p-3 bg-[#f0f5ed] rounded-lg border border-[#c5d5be]/40">
                          <MapPin className="w-4 h-4 text-[#8B9D83] mt-0.5" />
                          <div>
                      ...
                      {/* Account Stats */}
                      <div className="mt-4 pt-4 border-t border-[#c5d5be]/40">
                        <h4 className="text-sm font-medium text-[#8B9D83] flex items-center gap-2 mb-3">
                          <Clock className="w-4 h-4" />
                          Account Activity
                        </h4>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="p-2 bg-[#f0f5ed] rounded-lg border border-[#c5d5be]/40 text-center">
                            <p className="text-xs text-[#53645a]">Login Count</p>
                            <p className="text-sm font-medium text-[#263b32]">{userData.loginCount}</p>
                          </div>
                          <div className="p-2 bg-[#f0f5ed] rounded-lg border border-[#c5d5be]/40 text-center">
                            <p className="text-xs text-[#53645a]">Last Login</p>
                            <p className="text-sm font-medium text-[#263b32]">{formatDate(userData.lastLogin)}</p>
                          </div>
                        </div>
                      </div>
                    </div>
