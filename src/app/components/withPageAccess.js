...
export function withPageAccess(WrappedComponent, requiredPageKey) {
    ...
    useEffect(() => {
      const checkAccess = async () => {
        try {
          ...
          const mappedKey = oldToNewKeyMap[requiredPageKey] || requiredPageKey;
          
          if (dashboardAccess.includes(mappedKey) || dashboardAccess.includes(requiredPageKey)) {
            setIsAuthorized(true);
          } else {
